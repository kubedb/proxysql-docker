...
#DELETED PRIMARY HOST FINDER CODE
...
#DELETED MONITOR USER CREATION CODE
#if [ $BACKEND_TLS_ENABLED == "true" ]; then
...
#DELETED MYSQL SERVERS CONFIGURING CODE
...
#DELETED PROXYSQL SERVERS CONFIGURING CODE
...
#DELETED CLUSTER ADMIN CONFIGURING CODE
